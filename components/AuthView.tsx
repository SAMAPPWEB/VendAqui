    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#F3F4F6]">
      <div className="w-full max-sm bg-white p-8 rounded-[32px] shadow-xl border border-gray-200 animate-slide">
        <div className="text-center mb-10">
          ...
          {maskedSupabaseUrl.toLowerCase().includes('.com') && (
            <div className="mt-2 text-[10px] text-red-500 font-bold bg-red-50 p-2 rounded-lg border border-red-100">
              ⚠️ ATENÇÃO: A URL parece terminar em .COM, mas o Supabase usa .CO
            </div>
          )}
        </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={loginMode === 'EQUIPE' ? "Usuário ou e-mail (VER6)" : "Informe seu nome ou e-mail"}
                  value={email}
